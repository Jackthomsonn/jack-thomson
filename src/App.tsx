      ...
      <div className="top">
        ...
        <div className="link-container">
          <a
            target="__blank"
            className="a-link"
            href="https://medium.com/@jackthomsonn/shell-ai-your-code-companion-right-in-your-terminal-3f748d1c14e9"
          >
            Read the Medium article about Shell AI
          </a>
        </div>
      </div>
    </div>
